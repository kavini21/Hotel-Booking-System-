...
const ExclusiveOffers =() => {
    return (
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w'>
            {exclusiveOffers.map((item)=>(
                <div key={item._id} className='grop relative flex flex-col items-start justify-between gap-1 pt-12 md:pt-18 px-4 rounded-xl text-white bg-no-repeat bg-cover bg-center' style={{backgroundImage: `url(${item.image})`}}>
